...
Upgrading that Oven
-------------------
A fume funnel is an upgrade for the Witches Oven that increases that increases the speed (over a normal furnace) by an additional 10%, and increases the chances of a by-product being produced by a further 25%. The Fume Funnel must be positioned next to the left or right of the witches oven with the same facing. Up to two funnels can be attached to one oven.

Parents:
 1. So Toasty
 2.
Tasks:
 1. Craft a fume funnel.


Filtering the Fume Funnels
--------------------------
A Filtered Fume Funnel is an upgrade to the Fume Funnel that increases the chance of a by-product being produced by a connected witches Oven by a further 5% above the normal Fume Funnel

Task:
 1. Craft a Fume Filter
 2. Craft a Filtered Fume Funnel
...
Circle of power
---------------
A magic circle is circle of space marked out by practitioners of ritual magic, which will contain energy and form a sacred space The circle is marked physically, drawn with a special type of chalk to a size appropriate to the ritual that is to be performed. Rituals are varied, although they are typically organized into rites associated with an aspect of one of the dimensions and the foci used are most likely related to this association. An Altar must be within 16 blocks of the heart glyph.
...
Text:
 1. Ritual chalk is crafted from Gypsum, Wood Ash and Tear of the Goddess.
 ...
 3. The book, Witchcraft: Circle Magic, describes all of the rites that may be performed by a witch using magic circles. Each page in the book describes the rite, the foci items, power and circles that are needed.
...
Mutandis Extremis
-----------------
Mutandis Extremis is an upgraded version of Mutandis that can mutate plants into other species. Mutandis Extremis has all the same properties as basic Mutandis but it can even be used on multi-stage plants like wheat, cactus, etc.

Text:
 1. Mutandis is created in the Witch's Cauldron using Mutandis and Netherwart. The Cauldron will need around 2000 power from an Altar.


Ent's Twig
----------
An Ent is a tree that has been animated by a woodland spirit, often disturbed by the destruction of other trees. They will appear occasionally when trees such as Rowan, Hawthorn and Alder are felled in large quantities. Ents are rather hard to kill by normal means, but they do have a healthy hatred of certain tools for some reason or another.
...
Mutating Sprig
--------------
The Mutating Sprig brings a degree of order to the chaotic nature of Mutandis, allowing more limited, but also more predictable effects. When used on Grass it Transmutes it into Mycellium, and turns sand under water into clay.

Parents:
 1. Mutandis Extremis
 2. Ent's Twig
Text:
 1. Mutating Sprig is created in the Witch's Cauldron using an Ent Twig, netherwart and Mutandis Extremis.

Grassper plant
--------------
The Grassper plant, is a simple plant into which a single object can be placed, by using the object on the plant. The plant will hold onto the item until the plant is used (right-clicked) a second time which will cause it to drop the object.

Parent: Mutating Sprig
Text:
 1. Four Grassper plants are created by placing a chest over still water and surrounding its four sides with tall grass. Using a Mutating Sprig on the chest will cause the tall grass to be mutated into Grassper plants


Enchanted Broom
---------------
Flying around on a broomstick is certainly one of the main characteristics associated with witchcraft, and this is exactly what an Enchanted Broom is. Crafting an Enchanted Broom requires a broom and flying ointment for use in the Rite of Infusion; as described in the book Witchcraft: Circle Magic.
...
Parents:
 ...
 3. Diamond Ore
Tasks:
 1. Brew a Flying ointment
 2. Craft a Broom
 3. Infuse the Broom in a Magic Circle
Text:
 1. Throw into the kettle, throw Redstone Soup, Long-duration Potion of Swiftness, Diamond, Feather, Wool of Bat and Belladonna.
 2.
 3. This rite must be done during the night. The Altar will need 3000 power, around the heart glyph a small circle and medium circle in Ritual Chalk.
