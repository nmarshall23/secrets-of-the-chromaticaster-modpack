...
// Adds/defines tool materials: 
//  name, Harvestlevel, durability, efficiency, damage vs entities, enchantability, repairmaterial, oreDicted
...
//addToolMaterial( "GEMFLINT",  1, 180,  5.0,  1.5,  4, "itemFlint" );

addToolMaterial( "COPPER",    1, 300,  4.0,  1.0,  13, "ingotCopper" );
addToolMaterial( "Copper",    1, 300,  4.0,  1.0,  13, "ingotCopper" );
addToolMaterial( "TIN",       1, 250,  4.5,  1.0,  16, "ingotTin" );

addToolMaterial( "BRONZE",    2, 350,  6.0,  1.75, 16, "ingotBronze" );

addToolMaterial( "IRON",      2, 500,  6.0,  2.0,  14, "ingotIron" );


addToolMaterial( "RAILCRAFT_STEEL", 5, 750, 7.0,  3.0, 12, "ingotSteel" );
addToolMaterial( "STEEL", 	    5, 750, 7.0,  3.0, 12, "ingotSteel" );

addToolMaterial( "HSLA",            5, 900, 7.0,  3.0, 12, "ingotHSLA" );

addToolMaterial( "INVAR",        5, 700, 7.5,  3.0, 18, "ingotInvar" );


if(isModLoaded("hammerz")) {
 addToolMaterial( "Invar",    5, 700,  7.5,  3.0, 18, "ingotInvar" );
 addToolMaterial( "Steel",    5, 750,  7.0,  3.0, 12, "ingotSteel" );
 addToolMaterial( "Platinum", 6, 2550, 9.0,  4.0, 20, "ingotPlatinum" );
}
...
//addToolMaterial( "PERIDOT", 5, 512,7.75,3.0,14, "gemPeridot" );
...
addArmorMaterial( "CLOTH", 5,1,3,2,1,15,"Leather" ); // Vanilla, Leather
